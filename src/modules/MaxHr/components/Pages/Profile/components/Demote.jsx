...
export const Demote = () => {
  ...
  const [TerminateShow, setTerminateShow] = React.useState(false);
    ...
    return (
      ...
      >
        <Modal.Body className="UploadDocumentModal_body bg-white">
          ...
          <div className="Terminate_Modal_title">
            <h3>Terminate Roushan</h3>
          </div>
          ...
          <div className="document_verification_app_btn_div text-center mt-4">
  ...
  return (
    <>
      <div className="profile_iner_cont">
        <div className="row ">
          <div className="col-xxl-10 col-xl-10 col-md-9 col-12">
            <div className="EmployeesDocument_top_title">
              <h3>Demote</h3>
            </div>
          </div>
          <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12 mb-xxl-0 mb-xl-0 mb-lmb-0 mb-md-0 mb-sm-3 mb-3">
            <div className="document_verification_app_btn_div">
              <button onClick={() => setTerminateShow(true)}>Terminate</button>
            </div>
          </div>
        </div>
